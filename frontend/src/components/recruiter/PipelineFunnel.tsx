    ...
    () => [
      {
        ...
        icon: UsersThree,
        color: "from-blue-500/20 to-blue-600/30 text-blue-600 border-blue-500/30 dark:text-blue-400",
      ...
      },
      {
        ...
        icon: CheckCircle,
        color: "from-cyan-500/20 to-cyan-600/30 text-cyan-700 border-cyan-500/30 dark:text-cyan-400",
      ...
      {
        label: "AI Proceed Recommendations",
        ...
        icon: Trophy,
        color: "from-emerald-500/20 to-emerald-600/30 text-emerald-600 border-emerald-500/30 dark:text-emerald-400",
